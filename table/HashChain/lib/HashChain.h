...
class HashChain : public table<Key, Value> {
private:
...
template <class Key, class Value>
inline Value* HashChain<Key, Value>::Find(Key key)
{
...
template <class Key, class Value>
inline bool HashChain<Key, Value>::Insert(Key _key, Value _value)
{
...
template <class Key, class Value>
inline bool HashChain<Key, Value>::Delete(Key key)
{
    int vector_id = Hash_func(key);
...
template<class Key, class Value>
inline Value HashChain<Key, Value>::GetValuePtr(void)
{
...
template<class Key, class Value>
inline void HashChain<Key, Value>::GoNext(void)
{
